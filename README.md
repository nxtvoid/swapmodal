...
Handle shadcn dialog, sheet and drawer with ease. Forked from [pushmodal](https://github.com/lindesvard/pushmodal) with improvements and bug fixes.
...
> We take for granted that you already have `@radix-ui/react-dialog` installed. If not ➡️ `bun i @radix-ui/react-dialog`
...
SwapModal is forked from [pushmodal](https://github.com/lindesvard/pushmodal) by [@lindesvard](https://github.com/lindesvard).
